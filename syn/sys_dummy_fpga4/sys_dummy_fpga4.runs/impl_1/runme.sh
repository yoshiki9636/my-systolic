...
HD_PWD='C:/share/my-systolic/syn/sys_dummy_fpga4/sys_dummy_fpga4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dummy_fpga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dummy_fpga_top.tcl -notrace
