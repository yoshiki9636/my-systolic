...
HD_PWD='C:/share/my-systolic/syn/sys_dummy_fpga4/sys_dummy_fpga4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dummy_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dummy_fpga_top.tcl
