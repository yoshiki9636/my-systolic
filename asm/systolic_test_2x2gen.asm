...
#immdefine imm_dma_dc 0x035
#immdefine imm_mem_start0 0x000
#immdefine imm_mem_start1 0x0d8
#immdefine imm_mem_start2 0x1b0
#immdefine imm_mem_start3 0x288
#immdefine imm_max_cntr 0x005
#immdefine imm_run_cntr 0x008
#immdefine imm_answer_start 0x360
#immdefine imm_result_start 0x3f0
#immdefine imm_check_cntr 0x023
#immdefine imm_dma_dc_s 0x009
#immdefine imm_dma_dc_s_2 0x001
#immdefine imm_mem_start_s0 0x3f0
#immdefine imm_mem_start_s1 0x414
#immdefine imm_mem_start_s2 0x438
#immdefine imm_mem_start_s3 0x45c
#immdefine imm_mem_start_s0s 0x480
#immdefine imm_mem_start_s1s 0x488
#immdefine imm_mem_start_s2s 0x490
#immdefine imm_mem_start_s3s 0x498
nop
nop
nop
nop
